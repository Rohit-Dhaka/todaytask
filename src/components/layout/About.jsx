...
import {
  ...
  Radio,
  Flame,
} from "lucide-react"; // Fire replaced with Spark
    ...
    <section className="bg-black  relative overflow-hidden">
      ...
      <div className="flex justify-center pb-[40px]">
        ...
        <div className="flex flex-row flex-wrap mx-[-12px] items-center">
          <div className="w-7/12 px-3">
            <p className="text-white font-poppins text-justify">
              ...
              innovative products that enhance everyday digital lifestyles. As a
              leading manufacturer and trader, we are committed to offering
              premium solutions that combine cutting-edge technology,
              durability, and modern design. Our expertise lies in crafting
              mobile accessories that not only meet global quality standards but
              also reflect the evolving needs of today’s tech-savvy customers.
              Whether it’s seamless connectivity,fast charging, or immersive
              sound, our products are designed to deliver unmatched performance.
              Every product undergoes strict quality checks to ensure
              performance, reliability, and long-term value. With an extensive
              catalog and a customer-first approach , we help brands and
              retailers scale faster by offering OEM/ODM services tailored to
              their business goals. By blending innovation with trust,{" "}
              <strong>Startechno Plast</strong> continues to empower brands and
              enrich customer experiences across India and beyond. Our vision is
              to remain at the forefront of the mobile accessories industry,
            ...
            >
              {products.map((item, index) => (
                <SwiperSlide key={index}>
                  <div className="bg-[#031227] text-white py-6 px-4 rounded-md shadow-md hover:shadow-lg transition duration-200 group mx-auto max-w-xs">
                    <div className="bg-white/10 p-2 rounded-md w-fit mb-2 group-hover:scale-105 duration-200 ease-linear mx-auto">
                      {item.icon}
                    </div>
        ...
        <div className="flex flex-row flex-wrap mx-[-12px] pt-10 relative">
          <div className=" absolute bottom-[-90%] left-[-15%] animate-pulse">
            <Gradienttwo />
          </div>
          {features.map((feature, index) => (
            <div
              className="lg:w-3/12 sm:w-6/12 w-full px-2 pt-3 z-10"
              key={index}
            >
              <div className="bg-[#031227] text-white px-[28px] py-[30px] h-full rounded-md shadow-md hover:shadow-lg transition duration-200 group">
                <div className="bg-white/10 p-2 rounded-md w-fit mb-2 group-hover:scale-105 duration-200 ease-linear">
                  {feature.icon}
                </div>
